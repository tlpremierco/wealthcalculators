  ...
  return(
    <div className="calc-body">
      ...
      <div className="f" style={{marginBottom:8}}>
        <label className="fl">Project Name / Address</label>
        <input value={jobName} onChange={e=>setJobName(e.target.value)} className="fi" placeholder="e.g. 1388 Everglades Blvd N — New Construction" style={{padding:"8px 10px"}}/>
      </div>
      {/* Top params */}
      ...
      <div className="results-block">
        <div className="rb-title">{jobName?`📋 ${jobName}`:"Project Summary"}</div>
    ...
    <div className="calc-body">
      <div className="g2" style={{alignItems:"stretch"}}>
        <div>
          {/* Job Name */}
          <div className="f" style={{marginBottom:8}}>
            <label className="fl">Job Name / Description</label>
            <input value={jobName} onChange={e=>setJobName(e.target.value)} className="fi" placeholder="e.g. Smith A/C Repair — 123 Main St" style={{padding:"8px 10px"}}/>
          </div>
          ...
          <div style={{background:"#0A1420",border:"1px solid #161F2B",borderRadius:7,padding:"10px 12px",marginBottom:11}}>
            <div style={{fontSize:9,fontWeight:700,color:"#a78bfa",letterSpacing:1.5,textTransform:"uppercase",marginBottom:8}}>Sub Contractor / Vendor</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 100px",gap:8,alignItems:"center"}}>
              <input value={subName} onChange={e=>setSubName(e.target.value)} className="td-input" placeholder="+ Sub / Vendor name" style={{fontSize:12,color:"#a78bfa"}}/>
          ...
          <div style={{background:"#0A1420",border:"1px solid #161F2B",borderRadius:7,padding:"12px 14px",marginTop:4}}>
            ...
            <div className="f" style={{marginBottom:10}}>
              <label className="fl">Tech Name</label>
              <input value={techName} onChange={e=>setTechName(e.target.value)} className="fi" placeholder="e.g. Mike" style={{padding:"8px 10px"}}/>
            </div>
        ...
        <div style={{background:"#08121C",border:"1px solid #151E28",borderRadius:10,padding:"20px 18px",display:"flex",flexDirection:"column",gap:12}}>
          ...
          {/* Header */}
          <div style={{paddingBottom:12,borderBottom:"1px solid #1A2535"}}>
            ...
            {jobName&&<div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:12,fontWeight:700,color:CT.gold,textAlign:"center",marginBottom:4}}>📋 {jobName}</div>}
            {techName&&<div style={{fontFamily:"'IBM Plex Mono',monospace",fontSize:10,color:"#38bdf8",textAlign:"center"}}>👤 Tech: {techName}</div>}
          </div>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10,flex:1}}>
            {[
              ...
              {label:"− Materials",        value:fm(v.materials),        col:"#fb923c"},
              {label:"− Labor",            value:fm(r.techLabor),        col:"#fb923c"},
              {label:`− Sub/Vendor${subName?` (${subName})`:""}`, value:fm(v.subContractor), col:"#a78bfa"},
              ...
              {label:`− Tech Share${techName?` (${techName})`:""}`, value:fm(r.techShare), col:"#60a5fa"},
    ...
    <div className="calc-body">
      <div className="g2" style={{alignItems:"stretch"}}>
        <div>
          ...
          <div className="f" style={{marginBottom:8}}>
            <label className="fl">Job Name / Description</label>
            <input value={jobName} onChange={e=>setJobName(e.target.value)} className="fi" placeholder="e.g. Johnson Kitchen Remodel" style={{padding:"8px 10px"}}/>
          </div>
          <div className="f">
